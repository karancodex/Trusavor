            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-1/2 relative">
                        <div className="aspect-[4/5] rounded-t-full rounded-b-[200px] overflow-hidden bg-premium-light relative shadow-2xl">
                            <img
                                src="/assets/wellness_hero.png"
                                alt="Laboratory"
                                className="w-full h-full object-cover transition-all duration-1000"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-premium-dark/60 to-transparent" />
                    ...
                    <div className="w-full lg:w-1/2">
                        <span className="text-premium-accent font-bold uppercase tracking-[0.2em] text-xs mb-4 block">Our Philosophy</span>
                        <h2 className="text-5xl md:text-7xl font-serif text-premium-text-primary mb-8 leading-tight">
                            Beyond <br /> <i className="text-premium-text-muted">Surface Level.</i>
                        </h2>
                        <p className="text-premium-text-secondary text-lg font-light leading-relaxed mb-12">
                        ...
                        <div className="space-y-8">
                            {[
                                ...
                                >
                                    <div className="w-12 h-12 rounded-full bg-premium-light flex items-center justify-center text-premium-text-primary group-hover:bg-premium-text-primary group-hover:text-premium-surface transition-colors">
                                        <item.icon className="w-5 h-5" />
                                    </div>
                                    <div>
                                        <h4 className="text-xl font-serif text-premium-text-primary mb-1">{item.title}</h4>
                                        <p className="text-premium-text-secondary text-sm max-w-xs">{item.text}</p>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
