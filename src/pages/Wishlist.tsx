        ...
        return (
            <div className="min-h-screen pt-48 px-6 bg-[#0a0a0a] text-center relative overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="relative z-10">
                    <Heart className="w-16 h-16 text-white/5 mx-auto mb-8" />
                    <h1 className="text-4xl md:text-5xl font-serif font-black text-white italic mb-6 tracking-tighter">Empty Archive</h1>
                    <p className="text-white/20 text-lg font-light italic mb-12">Your ritual selection is waiting to be curated.</p>
                    <Link to="/all-collections" className="inline-flex items-center gap-4 px-10 py-4 bg-white text-black rounded-full font-black uppercase text-[9px] tracking-widest hover:scale-105 transition-all shadow-xl">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <span className="font-black tracking-[0.4em] uppercase text-[8px] text-white/30">
                            YOUR CURATED SELECTION
                        </span>
                    </div>
                    <h1 className="text-6xl md:text-7xl font-serif font-black text-white italic tracking-tighter">Wishlist</h1>
                </motion.div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-10 lg:gap-x-20">
