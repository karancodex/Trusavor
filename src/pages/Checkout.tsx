    ...
    return (
        <div className="min-h-screen pt-40 pb-24 bg-premium-light relative overflow-hidden font-sans">
            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                <div className="bg-white/80 backdrop-blur-3xl rounded-[48px] border border-stone-200 overflow-hidden shadow-2xl">
                    <div className="flex border-b border-stone-200">
                        <div className={clsx("flex-1 py-6 text-center font-black uppercase text-[9px] tracking-[0.3em] transition-all", step === 1 ? "text-premium-text-primary bg-stone-100/50" : "text-premium-text-muted")}>01. Identity</div>
                        <div className={clsx("flex-1 py-6 text-center font-black uppercase text-[9px] tracking-[0.3em] transition-all", step === 2 ? "text-premium-text-primary bg-stone-100/50" : "text-premium-text-muted")}>02. Essence Transfer</div>
                    </div>
